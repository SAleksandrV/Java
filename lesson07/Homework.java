package lesson07;
/* Дополнить программу про котов. Создать массив из котов 3-5. Коты едят из одной тарелке.
В тарелке с едой не должно быть отрицательное колличество еды.
У каждого кота должен быть параметр сытость (true), если не поел и голоден (false).
